...
public class JettyRpcHandler extends AbstractHandler {
    ...
    private JsonNode getBody(HttpServletRequest request) throws IOException {
        ...
        return JsonUtil.fromJSON(request.getInputStream(), JsonNode.class);
    }
